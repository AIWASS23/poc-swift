...
extension MeshResource {
    ...
    static func generateTetrahedron(radius: Float, res: Int = 0) throws -> MeshResource {
        let pointCount = 4
        var triangles = 4
    ...
    static func generateHexahedron(radius: Float, res: Int = 0) throws -> MeshResource {
        let pointCount = 8
        var quads = 6
        var vertices = pointCount * 3
    ...
    static func generateOctahedron(radius: Float, res: Int = 0) throws -> MeshResource {
        let pointCount = 6
        var triangles = 8
    ...
    static func generateDodecahedron(radius: Float, res: Int = 0) throws -> MeshResource {
        let pointCount = 20
        let pentagons = 12
        var vertices = pointCount * 3
    ...
    static func generateIcosahedron(radius: Float, res: Int = 0) throws -> MeshResource {
        let pointCount = 12
        var triangles = 20
