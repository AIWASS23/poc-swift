...
struct Smile: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        return Path { path in
            ...
            // MARK: - changing values for Up Curve and Down Curve
...
// MARK: - Eye Shape
struct Eyes: Shape {
    // MARK: - Optional Values For Only Changing top eye curve position
    var value: CGFloat?
