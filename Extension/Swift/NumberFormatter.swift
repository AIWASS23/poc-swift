...
//		formatter.allowsFloats = false
	...
	static var timecodeFormatter: TimeCodeFormatter = {
		let formatter = TimeCodeFormatter()
		formatter.allowsFloats = true
	...
	static var exposureTimeFormatter: ExposureTimeFormatter = {
		let formatter = ExposureTimeFormatter()
		formatter.allowsFloats = true
		formatter.numberStyle = .decimal
		formatter.maximumFractionDigits = 1
		formatter.positiveFormat = "#.#"
...
class ExposureTimeFormatter : NumberFormatter, @unchecked Sendable {
...
class TimeCodeFormatter : NumberFormatter, @unchecked Sendable {
	var showsHours = true
